...
import no.nav.pensjon.controller.TokenHelper.Issuer.DIFI
...
internal class TokenHelperTest {
    ...
    inner class ValidTokens {
        ...
        private val context = TokenValidationContext(mapOf(TOKENDINGS.name.lowercase() to jwt, DIFI.name.lowercase() to jwt))
