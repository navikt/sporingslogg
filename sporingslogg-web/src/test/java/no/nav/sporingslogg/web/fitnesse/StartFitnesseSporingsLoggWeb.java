...
public class StartFitnesseSporingsLoggWeb {
	...
	public static void main(String[] args) {
		...
		System.out.println("Starting StartFitnesseSporingsLoggWeb at port " + FITNESSE_PORT);
		try {
			new FitNesseMain().launchFitNesse(new Arguments(fitnesseCommandLine.split(" "))); // kan bruke ContextConfigurator
			System.out.println("StartFitnesseSporingsLoggWeb started");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
